...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Facturea — Devis & factures pour freelances" },
      {
        name: "description",
        content:
          "Créez devis et factures conformes, suivez vos clients et vos paiements. Pensé pour les indépendants et artisans.",
      },
